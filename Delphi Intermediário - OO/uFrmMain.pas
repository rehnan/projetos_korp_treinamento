...
begin
  ...
  if EdtHorasVoo.Text<>'' then
     ...
     // Fazendo cast pra conversão da classe
...
begin
  //Neste Caso será chamado o método Voar da Classe TAviao
  //TAviao(Aviao).Mover;

  //Neste Caso será chamado o método Voar da Classe TMeioTransporte
  Aviao.Mover;
end;
...
begin
  //Neste Caso será chamado o método Voar da Classe TCarro
  //TCarro(Carro).Mover;
