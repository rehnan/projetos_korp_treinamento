...
uses
  ...
  Vcl.ActnMenus, Vcl.RibbonActnMenus, Vcl.ScreenTips;
...
type
    ...
    ActionMensagemSair: TAction;
    ActionFechaApp: TAction;
    RibbonQuickAccessToolbar1: TRibbonQuickAccessToolbar;
    ScreenTipsManagerHelper: TScreenTipsManager;
    ...
    procedure ActionMensagemSairExecute(Sender: TObject);
    procedure ActionFechaAppExecute(Sender: TObject);
...
procedure TForm1.ActionFechaAppExecute(Sender: TObject);
begin
  Close;
end;

procedure TForm1.ActionMensagemSairExecute(Sender: TObject);
begin
  ShowMessage('A aplicação será finalizada! Clique em OK.');
  Close;
end;
...
begin
  ShowMessage('Relatório de Compras!');
end;
...
begin
  ShowMessage('Relatório de Movimentação!');
end;

procedure TForm1.VendasNFEsSaidaExecute(Sender: TObject);
begin
  ShowMessage('NFEs de Saída!');
end;
