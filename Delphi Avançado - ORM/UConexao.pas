...
const
   EnderecoBanco = 'C:\Users\dev02\Desktop\Projetos\Delphi Avançado - ORM\BASE.s3db';
...
begin
   { Verifica se a Interface de conexão já foi setada }
...
begin
  { Retorna a INterface IDBConnection configurada e conectada }
   ...
   if Result = nil then
      ...
      ('Houve um erro ao criar a conexão!');
end;
